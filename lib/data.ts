export const FAKE_CHANNELS = [
  ...
  { id: '3', name: 'MoneyMindset FR', subs: '145K', subsNum: 145000, niche: 'Finance & Business', lang: 'Français', freq: '1x/semaine', email: 'contact@moneymindset.fr', desc: 'Investissement et liberté financière, audience très engagée, format long.', avatar: 'MM', color: '#B45309' },
  ...
  { id: '5', name: 'CodePulse', subs: '62K', subsNum: 62000, niche: 'Tech & Programmation', lang: 'Français', freq: '2x/mois', email: null, desc: 'Tutoriels dev web, cible développeurs juniors, format didactique.', avatar: 'CP', color: '#0C447C' },
  { id: '6', name: 'FitLife FR', subs: '178K', subsNum: 178000, niche: 'Fitness & Santé', lang: 'Français', freq: '4x/semaine', email: 'fitlife@gmail.com', desc: 'Workouts et nutrition, style motivant et énergique, beaucoup de before/after.', avatar: 'FL', color: '#166534' },
  ...
  { id: '10', name: 'StyleParis', subs: '267K', subsNum: 267000, niche: 'Beauté & Mode', lang: 'Français', freq: '3x/semaine', email: 'style@paris.fr', desc: 'Mode et lifestyle parisien, contenu très esthétique, brand deals nombreux.', avatar: 'SP', color: '#BE185D' },
  ...
  { id: '12', name: 'TechReviewPro', subs: '890K', subsNum: 890000, niche: 'Tech & Programmation', lang: 'Anglais', freq: '3x/semaine', email: null, desc: 'Smartphone reviews and unboxings, professional setup, millions of views.', avatar: 'TR', color: '#0F6E56' },
  { id: '13', name: 'FinanceEspanol', subs: '445K', subsNum: 445000, niche: 'Finance & Business', lang: 'Espagnol', freq: '2x/semaine', email: 'finanza@espanol.com', desc: 'Inversiones y libertad financiera, gran audiencia latinoamericana.', avatar: 'FE', color: '#B45309' },
  ...
  { id: '15', name: 'LifestyleDE', subs: '123K', subsNum: 123000, niche: 'Lifestyle & Vlog', lang: 'Allemand', freq: '2x/semaine', email: 'lifestyle@de.com', desc: 'Deutsches Lifestyle-Kanal, Reisen und Ernährung, sehr engagierte Community.', avatar: 'LD', color: '#0C447C' },
]
